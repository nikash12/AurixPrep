...
const steps = [
  {
    ...
    description: "Upload your resume and job description to generate personalized questions.",
  },
  {
    step: "02",
    title: "Practice & Learn",
    description: "Practice with voice-enabled AI interviews and get real-time feedback.",
  },
  {
    step: "03",
    title: "Track & Improve",
    description: "Monitor your progress and level up through our gamified system.",
  },
]
    ...
    <section className="w-full py-20 md:py-32  relative overflow-hidden">
      ...
      <div className="container px-4 md:px-6 relative mx-auto">
        ...
        <div className="relative flex flex-col md:flex-row items-center justify-center gap-16 md:gap-24">
          ...
          <div className="hidden md:block absolute top-1/2 left-0 right-0 h-0.5 bg-gradient-to-r from-transparent via-border to-transparent -z-10"></div>
